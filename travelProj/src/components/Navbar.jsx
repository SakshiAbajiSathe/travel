...
<Link to="/" className="hover:text-yellow-500 font-bold">
        ...
        <Link to="/testimonials" className="hover:text-yellow-500 font-bold">
          Testimonials
        </Link>
      ...
      <div className="flex gap-4">
        <button className="font-bold hover:text-yellow-500">Login</button>
        <button className="border px-4 py-1 rounded font-bold hover:bg-yellow-500 hover:text-white">
          Sign up
        </button>
      </div>
